...
import kesun.bll.system.impl.SellServiceImpl;
...
@Controller
@RequestMapping("sell")
public class SellController extends SuperController implements kesun.controller.system.ISell {
    @Resource(name="bSell")
    private SellServiceImpl bll;//业务层对象变量
    ...
    public String index()
    {
        return "system/sell/sellManage";
    }

    @RequestMapping(value ="updateParent",method = RequestMethod.POST)
    @ResponseBody
    public Object updateParent(Sell node) {
