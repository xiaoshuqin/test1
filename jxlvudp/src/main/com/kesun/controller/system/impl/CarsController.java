...
@Controller
@RequestMapping("cars")
public class CarsController extends SuperController implements kesun.controller.system.ICars {
    @Resource(name="bCars")
    private CarsServiceImpl bll;//业务层对象变量
    ...
    public String index()
    {
        return "system/cars/carsManage";
    }

    @RequestMapping(value ="updateParent",method = RequestMethod.POST)
    @ResponseBody
    public Object updateParent(Cars node) {
