...
<form class="layui-form" id="ff">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="age" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入年龄" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="education" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入学历" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">职位：</label>
        <div class="layui-input-block">
            <input name="post" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入职位" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">工资：</label>
        <div class="layui-input-block">
            <input name="salary" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入工资" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">电话：</label>
        <div class="layui-input-block">
            <input name="tel" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入电话" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
