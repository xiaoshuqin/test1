...
<table class="easyui-datagrid" title="厂家管理" style="height:auto" id="dgVender"
    ...
    <tr>
        ...
        <th data-options="field:'id',width:80">厂家编号</th>
        <th data-options="field:'name',width:180">厂家名称</th>
        <th data-options="field:'tel',width:200">厂家电话</th>
        <th data-options="field:'address',width:200">厂家地址</th>
...
<script src="<%=basePath%>/script/business/system/venderManage.js"></script>
