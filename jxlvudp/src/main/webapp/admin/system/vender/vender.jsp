...
<form class="layui-form" id="ff">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input id="id" name="id" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入厂家编号" class="layui-input" type="text" >
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">厂家名称：</label>
        <div class="layui-input-block">
            <input name="name" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入厂家名称" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">厂家电话：</label>
        <div class="layui-input-block">
            <input name="tel" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入厂家电话" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">厂家地址：</label>
        <div class="layui-input-block">
            <input name="address" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入厂家地址" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
