...
function find() {
    jxmstc.findForEasyui("dgCars",getCondition());
}
...
$(function () {
    ...
    jxmstc.browserForEasyui(function (obj) {
        ...
        var toUrl=getRootPath()+"/admin/system/cars/cars.jsp?type=2&id="+obj.id;
        layer.open({
            title:'汽车信息浏览',
            type: 2,
            area:["100%","100%"],
    ...
    jxmstc.editForEasyui(function (obj) {
        var toUrl=getRootPath()+"/admin/system/cars/cars.jsp?type=1&id="+obj.id;
        layer.open({
            title:'汽车信息修改',
            type: 2,
            area:["100%","100%"],
    ...
    $("#btnDeleteAll").click(function () {
        var ids=jxmstc.getEasyuiGridSelectRowsID("dgCars");
        if (ids=="") return;
        var obj=new Object();
        obj.ids=ids;
