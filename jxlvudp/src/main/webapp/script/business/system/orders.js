...
$(function () {
    ...
    jxmstc.browserForEasyui(function (obj) {
        ...
        var toUrl=getRootPath()+"/admin/system/orders/orders.jsp?type=2&id="+obj.id;
        layer.open({
            title:'订单信息浏览',
            type: 2,
            area:["100%","100%"],
    ...
    jxmstc.editForEasyui(function (obj) {
        var toUrl=getRootPath()+"/admin/system/orders/orders.jsp?type=1&id="+obj.id;
        layer.open({
            title:'订单信息修改',
            type: 2,
            area:["100%","100%"],
    ...
    jxmstc.delForEasyui("您确定删除当前选的信息吗？",function (data) {
     ...
     $("#btnFresh").click(function () {
        var obj = new Object();
        obj.condition = "";
        jxmstc.findForEasyui("dgOrders",obj)
     });

    $("#btnAdd").click(function () {
        var toUrl=getRootPath()+"/admin/system/orders/orders.jsp?type=0";
        layer.open({
            title:'订单信息新增',
            type: 2,
            area:["100%","100%"],
