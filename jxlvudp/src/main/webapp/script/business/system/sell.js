...
function find() {
    jxmstc.findForEasyui("dgSell",getCondition());
}
...
$(function () {
    ...
    jxmstc.browserForEasyui(function (obj) {
        ...
        var toUrl=getRootPath()+"/admin/system/sell/sell.jsp?type=2&id="+obj.id;
        layer.open({
            title:'汽车信息浏览',
            type: 2,
            area:["100%","100%"],
    ...
    jxmstc.editForEasyui(function (obj) {
        var toUrl=getRootPath()+"/admin/system/sell/sell.jsp?type=1&id="+obj.id;
        layer.open({
            title:'销售信息修改',
            type: 2,
            area:["100%","100%"],
    ...
    $("#btnAdd").click(function () {
        var toUrl=getRootPath()+"/admin/system/sell/sell.jsp?type=0";
        layer.open({
            title:'销售信息新增',
            type: 2,
            area:["100%","100%"],
    ...
    $("#btnDeleteAll").click(function () {
        var ids=jxmstc.getEasyuiGridSelectRowsID("dgSell");
        if (ids=="") return;
        var obj=new Object();
        obj.ids=ids;
